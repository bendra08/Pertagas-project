    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Notulen Add</h3>
            </div>
            <?php echo form_open('notulen/add'); ?>
            <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="perihal"
                                        value="<?php echo $this->input->post('perihal'); ?>" class="form-control"
                                        id="perihal" />
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="waktu" value="<?php echo $this->input->post('waktu'); ?>"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="daftar_hadir"
                                        value="<?php echo $this->input->post('daftar_hadir'); ?>" class="form-control"
                                        id="daftar_hadir" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="id_fungsi"
                                        value="<?php echo $this->session->userdata('id_fungsi') ?>" class="form-control"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="no_kbo"
                                        value="<?php echo $this->session->userdata('no_kbo') ?>" class="form-control"
                                        id="no_kbo" readonly />
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="ttd_1" value="<?php echo $this->input->post('ttd_1'); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="jabatan1"
                                        value="<?php echo $this->input->post('jabatan1'); ?>" class="form-control"
                                        id="jabatan1" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="ttd_2" value="<?php echo $this->input->post('ttd_2'); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="jabatan2"
                                        value="<?php echo $this->input->post('jabatan2'); ?>" class="form-control"
                                        id="jabatan2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="ttd_3" value="<?php echo $this->input->post('ttd_3'); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="jabatan3"
                                        value="<?php echo $this->input->post('jabatan3'); ?>" class="form-control"
                                        id="jabatan3" />
                                </div>
                            </div>
                        </div>

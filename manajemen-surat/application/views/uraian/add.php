    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Uraian Add</h3>
            </div>
            <?php echo form_open('uraian/add/'); ?>
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="no_uraian" value="<?php echo $this->input->post('no_uraian'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="rencana" value="<?php echo $this->input->post('rencana'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" name="jangka_waktu"
                                value="<?php echo $this->input->post('jangka_waktu'); ?>" placeholder="YYYY-MM-DD"
                                data-date-format="yyyy-mm-dd" class="form-control pull-right" id="tanggal_po"
                                autocomplete="off" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="penanggung_jawab"
                                value="<?php echo $this->input->post('penanggung_jawab'); ?>" class="form-control"
                                id="penanggung_jawab" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="uraian" class="form-control"
                                id="uraian"><?php echo $this->input->post('uraian'); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>

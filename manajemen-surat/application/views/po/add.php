    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Po Add</h3>
            </div>
            <?php echo form_open('po/add'); ?>
            <div class="box-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="no_po" value="<?php echo $this->input->post('no_po'); ?>"
                                        class="form-control" id="no_po" required />
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="nama_perusahaan"
                                        value="<?php echo $this->input->post('nama_perusahaan'); ?>"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" name="pemilik_pekerjaan"
                                        value="<?php echo $this->input->post('pemilik_pekerjaan'); ?>"
							...
							<div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <textarea name="judul_pembayaran" class="form-control"
                                        id="judul_pembayaran"><?php echo $this->input->post('judul_pembayaran'); ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
								...
								<div class="input-group date">
									...
									<input type="text" name="tanggal_po"
                                        value="<?php echo $this->input->post('tanggal_po'); ?>" placeholder="YYYY-MM-DD" data-date-format="yyyy-mm-dd" class="form-control pull-right"

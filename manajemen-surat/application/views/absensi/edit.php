    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Absensi Edit</h3>
            </div>
            <?php echo form_open('absensi/edit/'.$absensi['no_absensi']); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <label for="no_absensi" class="control-label">No Absensi</label>
                        <div class="form-group">
                            <input type="text" name="no_absensi" value="<?php echo ($this->input->post('no_absensi')) ? $this->input->post('no_absensi') : $absensi['no_absensi']; ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="agenda" value="<?php echo ($this->input->post('agenda')) ? $this->input->post('agenda') : $absensi['agenda']; ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="hari_tanggal"
                                value="<?php echo ($this->input->post('hari_tanggal')) ? $this->input->post('hari_tanggal') : $absensi['hari_tanggal']; ?>" class="form-control"
                                id="hari_tanggal" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="pukul" value="<?php echo ($this->input->post('pukul')) ? $this->input->post('pukul') : $absensi['pukul']; ?>"
